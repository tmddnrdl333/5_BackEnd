        ...
        $(document).ready(function () {
            $("#modifyBtn").click(function () {
                if (!$("#noticeTitle").val()) {
                    ...
                    $("#writeform").attr("action", "${pageContext.request.contextPath}/notice/modify.do").submit();
                }
            });
        });
    </script>
<div style="text-align: center; font-family: 'Jua', sans-serif">
    <div class="container text-center mt-3">
        <div class="col-lg-8 mx-auto">
            <h2 class="p-3 mb-3 shadow bg-light"><mark style="text-align: center; font-family: 'Jua', sans-serif">글수정</mark></h2>
            <form id="writeform" class="text-left mb-3" method="post" action="">
                ...
                <div class="text-center">
                    <button class="btn btn-success" type="button" id="modifyBtn" class="btn btn-outline-primary">글수정</button>
